(function (global, factory) {
    ...
    class ServiceError$1 extends Error {
    ...
    class NotFoundError$1 extends ServiceError$1 {
    ...
    class RequestError$3 extends ServiceError$1 {
    ...
    class ConflictError$2 extends ServiceError$1 {
    ...
    class AuthorizationError$2 extends ServiceError$1 {
    ...
    class CredentialError$2 extends ServiceError$1 {
    ...
    const uuid$1 = util$2.uuid;


    const data$1 = fs__default["default"].existsSync('./data') ? fs__default["default"].readdirSync('./data').reduce((p, c) => {
    ...
    dataService$1.get(':collection', actions.get);
    dataService$1.post(':collection', actions.post);
    dataService$1.put(':collection', actions.put);
    dataService$1.patch(':collection', actions.patch);
    dataService$1.delete(':collection', actions.delete);


    var jsonstore = dataService$1.parseRequest;
    ...
    const { NotFoundError, RequestError: RequestError$2 } = errors;
    ...
    function get(context, tokens, query, body) {
        ...
        try {
            ...
            if (err.message.includes('does not exist')) {
                ...
                throw new RequestError$2(err.message);
            }
        }
    ...
    function post(context, tokens, query, body) {
        ...
        validateRequest(context, tokens);
        if (tokens.length > 0) {
            throw new RequestError$2('Use PUT to update records');
        }
    ...
    function put(context, tokens, query, body) {
        ...
        validateRequest(context, tokens);
        if (tokens.length != 1) {
            throw new RequestError$2('Missing entry ID');
        }
    ...
    var data = dataService.parseRequest;
    ...
    var storage = initPlugin$3;

    const { ConflictError: ConflictError$1, CredentialError: CredentialError$1, RequestError: RequestError$1 } = errors;
        ...
        return function decorateContext(context, request) {
            ...
            function register(body) {
                if (body.hasOwnProperty(identity) === false ||
                    ...
                    throw new RequestError$1('Missing fields');
    ...
    var util = initPlugin$1;

    /*
     * This plugin requires auth and storage plugins
     */

    const { RequestError, ConflictError, CredentialError, AuthorizationError } = errors;
    ...
    var seedData = {
        ...
        "985d9eab-ad2e-4622-a5c8-116261fb1fd3": {
            ...
            "text": "Rolls Royce was voted the world's most beautiful coupe in the annual 'World's Most Beautiful Automobile",
            "year": "1954",
            "_id": "304bca9e-c713-4e72-b686-6b67ff7bf113",
            _createdOn: 1614260681385,
        },
        "985d9eab-ad2e-4622-a5c8-116261fb1fd4": {
            "ownerId": "35c62d76-8152-4626-8712-eeb96381bea8",
            "manufacturer": "Ford",
            "model": "Mustang",
            "mileage": "320000",
            ...
            "text": "Mustang was voted the world's most beautiful coupe in the annual. 'World's Most Beautiful Automobile",
            "year": "1954",
            "_id": "304bca9e-c713-4e72-b686-6b67ff7bf113",
            _createdOn: 1614260681385,
        },
        "985d9eab-ad2e-4622-a5c8-116261fb1fd8": {
            ...
            "text": "Sonata was voted the world's most beautiful coupe in the annual. 'World's Most Beautiful Automobile",
            "year": "1985",
            "_id": "304bca9e-c713-4e72-b686-6b67ff7bf123",
            _createdOn: 1614260681395,
        },
        "985d9eab-ad2e-4622-a5c8-116261fb1fd5": {
            "ownerId": "35c62d76-8152-4626-8712-eeb96381bea8",
            ...
            "text": "Line GT was voted the world's most beautiful coupe in the annual. 'World's Most Beautiful Automobile",
            "year": "1965",
            "_id": "304bca9e-c713-4e72-b686-6b67ff7bf114",
        ...
        "8f414b4f-ab39-4d36-bedb-2ad69da9c830": {
            ...
            "price": "50 000",
            "image": "../../image/featurporch.jpg",
            "text": "The most perfect sports car ever. Incredible performance, whilst being comfortable and fully suitable for everyday use",
            "year": "1990",
            "_id": "304bca9e-c713-4e72-b686-6b67ff7bf111",
            _createdOn: 1613551344360            
        },
        "985d9eab-ad2e-4622-a5c8-116261fb1fd2": {
            "ownerId": "304bca9e-c713-4e72-b686-6b67ff7bf12",
        ...
        messages: {
            "0a272c58-b7ea-4e09-a000-7ec988248f66": {
                ...
                content: "Great car!",
                carId: "8f414b4f-ab39-4d36-bedb-2ad69da9c830",
                _createdOn: 1614260681375,
                _id: "0a272c58-b7ea-4e09-a000-7ec988248f66"
            },
            
            "304bca9e-c713-4e72-b686-6b67ff7bf112": {
                _ownerId: "35c62d76-8152-4626-8712-eeb96381bea8",
                content: "Supper!",
